    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('edit-user', ['user'=>$user->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input id="name" type="text" class="mr-2 mt-3 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ? old('name') : $user->name }}"  autocomplete="title" autofocus>
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input id="email" type="email" class="mt-2 mr-2 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ? old('email') : $user->email }}"  autocomplete="email" autofocus>
